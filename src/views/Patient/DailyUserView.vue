        ...
        <div class="text-center hero-content">
          <div class="w-2/3">
            ...
            <p class="mb-5 text-lg">
              We want to remind you that this is a
              <strong> safe space, </strong>and all our counsellors are
              certified. <br />
              When you are ready, click the button below and your counsellor
              will join the room shortly.
            </p>
            ...
            <div class="card shadow-lg">
              <div class="card-body object-center">
                ...
                <p>
                  1. You can choose to communicate with your counsellor via
                  video call (require webcam permission), voice call (require
                  microphone permission), or via the chat box.
                </p>
                <br />
                <p>
                  2. Please do not feel pressured to disclose any information
                  you are not comfortable with.
                </p>
                <br />
                <p>
                  3. Information shared during the session remains confidential,
                  however they can be shared with your future counsellors on
                  this platform if you have chosen to share information with all
                  counsellors. (This option can be changed at any point of time
                  in your profile).
                </p>
              </div>
            </div>
            ...
            <div>
              <button class="btn btn-primary w-1/3" @click="createAndJoinRoom">
                Start Session Now
              </button>
...
export default {
  ...
  methods: {
    async createAndJoinRoom() {
      ...
      if (roomID == "") {
        // ie first time user is joining this session
        console.log("roomID == ''");
        api
          .createRoom()
          .then((room) => {
        ...
        // ie repeated time joining this session - the room_ID of the session should not change.
