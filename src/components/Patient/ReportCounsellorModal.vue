            ...
            <div id="wrapper">
                <div id="contact-form">
                    <form ref="form" @submit.prevent="sendEmail">
                        <input type="hidden" name="reporter" :value="this.user_email">
                        <input type="hidden" name="reportee" :value="this.counsellor_email">
