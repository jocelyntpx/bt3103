      ...
      <div>
        ...
        <div class="flex justify-center flex-col">
          <div class="grid h-auto card rounded-box place-items-center">
            <p id="letUsKnow">
              Do let us know of any queries/concerns/feedback you might have.<br />
              We value your opinions and will get back to you as soon as
              possible!
            </p>
            <br />
            <div id="wrapper">
              <div id="contact-form">
                <form ref="form" @submit.prevent="sendEmail">
                  ...
                  <input
                    type="email"
                    name="user_email"
                    placeholder="Optional: Leave an email if you like us to get back to you. ☺"
                  />
                  <label>Message</label>
                  <textarea
                    name="message"
